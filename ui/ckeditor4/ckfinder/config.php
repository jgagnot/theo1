...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/ui/ckeditor4/ckfinder/userfiles/',
//  'root'         => '', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777, // 777 obligatoire pour permettre les actions de modification de l'image…
    'chmodFolders' => 0755,
...
$config['accessControl'][] = array(
    ...
    'FOLDER_VIEW'         => true,
    'FOLDER_CREATE'       => false, // Laisser la configuration à l'utilisateur ?
    'FOLDER_RENAME'       => false,
    'FOLDER_DELETE'       => false,

    'FILE_VIEW'           => true,
    'FILE_CREATE'         => true,
    'FILE_RENAME'         => false, // Eviter le renommage pour eviter les 404 ?
    'FILE_DELETE'         => false,
...
$config['disallowUnsafeCharacters'] = true; // Def : Disallows creating folders and uploading files whose names contain characters that are not safe on an IIS web server.

...
class signaturitEvent
{

    private $_id;
    private $_userId;
    private $_signatureId;
    ...
    public function getSignatureId() { return $this->_signatureId;}
    public function setSignatureId($signatureId) { $this->_signatureId = $signatureId; }
